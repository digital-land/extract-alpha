...
You’ll remember from [last week](/weeknotes/benchmarking-begins/) that we started the first benchmarking session, and early this week it finished. 

In this first round of user research, we tested an interactive prototype of Extract with five users across four LPAs. This ‘[MVP Test](https://www.svpg.com/minimum-viable-product/#:~:text=the%20point%20of%20these%20MVP%20Tests%2C%20which%20is%20to%20get%20to%20this%20notion%20of%20Product%20Market%20Fit.%20%C2%A0That’s%20when%20we%20actually%20have%20a%20viable%20product.)’ allowed us to observe real users interacting with the tool in their actual context of use.
...
Making these social bonds isn’t just fun, it also helps the work _work_. So that we don’t only have a shared commitment to the goal but also to each other.

After lunch, Gordon kindly shared a gift he’d bought for each member of the team – an Extract [mission patch](https://www.instagram.com/p/C06VTlKOXyY/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==)!

![A laptop is covered in vibrant stickers – including the shiny Extract mission patch in pink.](extract-sticker-on-laptop.jpg)
...
[Get the obvious ideas out of the way and together we’ll come up with the good ones](https://interconnected.org/home/2023/11/24/digestion). 
...
![A 1965 map of Baston, Lincolnshire, showing a tree preservation order with marked trees highlighted in red on a detailed survey plan.](better-output-from-gemini-3.png)